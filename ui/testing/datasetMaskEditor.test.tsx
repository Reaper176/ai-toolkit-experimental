...
(globalThis as any).document = { createElement: (name: string) => name === 'canvas' ? canvas() : {} };
...
const nodeMock = (element: any) => element.type === 'canvas' ? canvas() : element.props?.className?.includes('overflow-hidden') ? { getBoundingClientRect: () => ({ left: 0, top: 0, width: 200, height: 100 }) } : {};
