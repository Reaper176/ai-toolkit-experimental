...
class AnimaSingleFileTests(unittest.TestCase):
    ...
    def test_normalize_qwen_image_vae_maps_every_comfy_key_family(self):
        mappings = {
            ...
            "encoder.downsamples.2.resample.weight": "encoder.down_blocks.2.resample.weight",
            "encoder.downsamples.1.time_conv.bias": "encoder.down_blocks.1.time_conv.bias",
            ...
            "decoder.upsamples.3.resample.weight": "decoder.up_blocks.0.upsamplers.0.resample.weight",
            ...
            "decoder.upsamples.7.resample.weight": "decoder.up_blocks.1.upsamplers.0.resample.weight",
            ...
            "decoder.upsamples.11.resample.weight": "decoder.up_blocks.2.upsamplers.0.resample.weight",
            "decoder.upsamples.11.time_conv.bias": "decoder.up_blocks.2.upsamplers.0.time_conv.bias",
